const char* ssid     = "realme narzo 30 5G";   //your network SSID
const char* password = "aaba2001";   //your network password
...
void loop() {
 ...
 if(P1=="Mask"){
  ...
  Serial.println("Gate Not Open..You can not go..");
